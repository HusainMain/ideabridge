...
export function ReportHeader(): React.ReactElement {
  ...
  const Meta = ({ icon: Icon, label, value }: { icon: React.ElementType, label: string, value: string }) => (
    <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col">
        <span className="text-[0.6rem] font-mono text-slate-500 uppercase tracking-wider">{label}</span>
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900/95 to-slate-950 p-4 md:p-5">
        {/* Gradient accent bar */}
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-4 items-center pt-1 border-t border-white/5">
